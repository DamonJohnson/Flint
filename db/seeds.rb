...
greg.items.create(title: 'foo', description: 'bar', price: 20.0, category_id: Category.first.id) #works
greg.profiles.create(first_name: 'Mike', last_name: 'Myers', address: '123 Fake Street', city: 'Sydney', postcode: 2000, state: 'New South Wales') #doesnt work
